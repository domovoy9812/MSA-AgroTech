...
Особенности:
   ...
   * Нотификации также требуют подключения к интернету, нет необходимости использовать специфические мессенджеры. В будущем после появления мобильного приложения можно будет предейти на push уведомления.
...
У альтернативной опции есть дополнительные недостатки:
   ...
   * Старая система развивалась сумбурно, могут возникнуть проблемы с масштабированием из-за увеличения нагрузки на уже существующие модули.
   * Рост нагрузки на БД ПМА будет расти с увеличением количества ферм, обслуживаемых системой. Со временем придется реализовать шардинг.
