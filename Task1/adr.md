...
Высокая отказоустойчивость обеспечивается за счет:
   * использование для взаимодействия между микросервисами в основном используется брокер сообщений с кластеризацией и подтверждением доставки сообщений
...
Использование проводных камер, требует более затратно при первоначальной установке, в условиях агрессивной среды на ферме может потребовать регулярного обслуживание ethernet линий.
